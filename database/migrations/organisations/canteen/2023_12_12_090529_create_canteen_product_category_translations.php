...
class CreateCanteenProductCategoryTranslations extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('canteen_product_category_translations', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('canteen_product_category_translations');
    }
}
