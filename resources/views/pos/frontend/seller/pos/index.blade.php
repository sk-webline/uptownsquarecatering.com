            ...
            <div class="row gutters-10">
                ...
                <div class="col-lg-7">
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <select name="user_id" class="form-control form-control-sm pos-customer sk-selectpicker" data-live-search="true" onchange="getShippingAddress()">
                    ...
                    <div class="card mb-3" id="cart-details">
                        <div class="card-body">
                            <div class="sk-pos-cart-list c-scrollbar">
                                <table class="table sk-table mb-0" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
