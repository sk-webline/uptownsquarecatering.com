            ...
            <div class="row gutters-10">
                    ...
                    <div class="card">
                        <div class="card-header d-block">
                            ...
                            <div class="row gutters-5">
                                <div class="col-md-6">
                                    <select name="poscategory" class="form-control form-control-sm sk-selectpicker" data-live-search="true" onchange="filterProducts()">
                                ...
                                <div class="col-md-6">
                                    <select name="brand"  class="form-control form-control-sm sk-selectpicker" data-live-search="true" onchange="filterProducts()">
                        ...
                        <div class="card-body">
                            <div class="sk-pos-product-list c-scrollbar-light">
                ...
                <div class="col-lg-7">
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <select name="user_id" class="form-control form-control-sm sk-selectpicker pos-customer" data-live-search="true" onchange="getShippingAddress()">
                    ...
                    <div class="card mar-btm" id="cart-details">
                        <div class="card-body">
                            <div class="sk-pos-cart-list c-scrollbar-light">
                                <table class="table sk-table mb-0 mar-no" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class=" row">
                                ...
                                <div class="col-sm-10">
                                    <select name="country" id="country" class="form-control sk-selectpicker" required data-placeholder="{{translate('Select country')}}">
    ...
    <script type="text/javascript">
        ...
        function submitOrder(payment_type){
            ...
            $.post('{{ route('pos.order_place') }}',{_token:'{{ csrf_token() }}', user_id:user_id, name:name, email:email, address:address, country:country, city:city, postal_code:postal_code, phone:phone, shipping_address:address, payment_type:payment_type, shipping:shipping, discount:discount}, function(data){
                if(data == 1){
                    SK.plugins.notify('success', '{{ translate('Order Completed Successfully.') }}');
                    location.reload();
                }
                else{
