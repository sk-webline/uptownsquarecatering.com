    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-8 mx-auto">
                <div class="row sk-steps arrow-divider">
                    <div class="col done">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control sk-selectpicker" data-live-search="true" name="country">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 sk-selectpicker" data-live-search="true" name="country" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 sk-selectpicker" data-live-search="true" name="city" required>
