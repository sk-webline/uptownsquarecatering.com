...
//    $today_purchased_plans = $today_plan['today_purchased_plans'];
    ...
    <div id="content_body" class="mh-100-svh fs-12 md-fs-15 lg-fs-17 ">
        ...
        <div class="cashier-header ">
            ...
            <div class="cashier-grid border-primary border-width-2 border-bottom">
...
{{--                <div class="col border-primary border-width-2 border-bottom">--}}

{{--                </div>--}}

{{--                <div class="col-auto border-radius-30px shadow-md fs-15 lh-1-7 px-15px">--}}
{{--                        <span class="text-primary">--}}
{{--                             <svg class="h-20px mr-1 "--}}
{{--                                  xmlns="http://www.w3.org/2000/svg"--}}
{{--                                  viewBox="0 0 21.18 21.27">--}}
...
{{--            </div>--}}
        ...
        <form action="{{route('canteen_cashier.current_break_delivery')}}" method="post" class="form-horizontal scrollable-div" >
            @csrf
                        ...
                        <div class="cashier-grid @if(!$active) opacity-50 @endif">
                            ...
                            <div class="row gutters-10 sm-gutters-30 my-20px text-black align-content-around">
                                ...
                                @foreach($items as $canteen_product_id => $quantity)
                                    ...
                                    <div class="col-auto product-card @if($active) selected @endif">
