            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control sk-tag-input" name="tags[]" id="tags"
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <select class="form-control sk-selectpicker" data-live-search="true"
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <select name="choice_attributes[]" data-live-search="true" data-selected-text-format="count"
                        id="choice_attributes" class="form-control sk-selectpicker" multiple
            ...
            <div class="customer_choice_options" id="customer_choice_options">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control sk-tag-input"
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-3">
                    <select class="form-control sk-selectpicker" name="discount_type" required>
        ...
        <div class="card">
            ...
            <div class="card-body collapse show" id="collapse_2">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <label class="sk-switch sk-switch-success mb-0">
                            <input type="radio" name="shipping_type" value="product_wise" @if($product->shipping_type ==
                            'product_wise') checked @endif>
                            <span></span>
                        </label>
                    </div>
                </div>
                ...
                <div class="product_wise_shipping_div" style="display: none">
                    ...
                    <div class="form-group row">
                        ...
                        @endphp
                        <div class="col-md-6">
                            <input type="text" class="form-control" min="0" value="{{ $shipping_cost }}" step="1"
