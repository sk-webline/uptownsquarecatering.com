          ...
          <div class="card-header row gutters-5">
            <div class="col text-center text-md-left">
              ...
              <div class="col-md-3 ml-auto">
                  <select class="form-control sk-selectpicker" data-placeholder="{{ translate('Filter by Payment Status')}}" name="payment_status" onchange="sort_orders()">
              ...
              <div class="col-md-3 ml-auto">
                <select class="form-control sk-selectpicker" data-placeholder="{{ translate('Filter by Payment Status')}}" name="delivery_status" onchange="sort_orders()">
