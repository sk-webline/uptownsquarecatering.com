        ...
        <div class="col-lg-6">
            <div class="row gutters-10 flex-row-reverse">
                ...
                <div class="col-auto w-90px">
                    <div class="sk-carousel carousel-thumb product-gallery-thumb" data-items='5' data-nav-for='.product-gallery' data-vertical='true' data-focus-select='true'>
                        @foreach ($product->stocks as $key => $stock)
                            @if ($stock->image != null)
                        ...
                        @if ($product->choice_options != null)
                            @foreach (json_decode($product->choice_options) as $key => $choice)
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-10">
                                        <div class="sk-radio-inline">
                                            @php
                                                $count = 0;
                                            @endphp
                                            @foreach (sortSizes($choice->values) as $key => $value)
                                            <label class="sk-megabox pl-0 mr-2">
                                                <input
                                                    type="radio"
                                                ...
                                                >
                                                <span class="sk-megabox-elem rounded d-flex align-items-center justify-content-center py-2 px-3 mb-2">
                                                    {{ $value['name'] }}
                                                </span>
                                            </label>
                                            @php
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-10">
                                    <div class="sk-radio-inline">
                                        ...
                                        <label class="sk-megabox pl-0 mr-2" data-toggle="tooltip" data-title="{{ \App\Color::where('code', $color)->first()->name }}">
                                            <input
                                                type="radio"
                                                name="color"
                                            ...
                                            >
                                            <span class="sk-megabox-elem rounded d-flex align-items-center justify-content-center p-1 mb-2">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-10">
                                <div class="product-quantity d-flex align-items-center">
                                    <div class="row no-gutters align-items-center sk-plus-minus mr-3" style="width: 130px;">
