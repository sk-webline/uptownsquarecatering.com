...
<div class="modal-body pt-0 pb-0" style="height: 350px">
    ...
    <div class="text-center pt-2 mt-2 mx-5 fs-17 ff-Manrope fw-600">
        <a class="addCateringPlanToCart"> <button id="{{$catering_plan->id}}"
                                                  class="my-4 w-100 btn btn-custom-4 ff-Manrope text-uppercase fw-600 addCateringPlanToCart"
                                                data-button="remove_prev" onclick="addCateringPlanToCart_function() "
            >  {{ translate('Add To Cart') }}</button></a>
