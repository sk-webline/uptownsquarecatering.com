...
<head>
    ...
    @endif
    <link rel="stylesheet" href="{{ static_asset('assets/css/aos.css') }}">
...
<body>
    ...
    <script src="{{ static_asset('assets/js/aos.js') }}"></script>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.category-nav-element').each(function(i, el) {
                $(el).on('mouseover', function(){
                    if(!$(el).find('.sub-cat-menu').hasClass('loaded')){
                        $.post('{{ route('category.elements') }}', {_token: SK.data.csrf, id:$(el).data('id')}, function(data){
            ...
            if ($('#lang-change-fixed').length > 0) {
                $('#lang-change-fixed .dropdown-menu a').each(function() {
                    $(this).on('click', function(e){
                        e.preventDefault();
                        var $this = $(this);
                        var locale = $this.data('flag');
        ...
        function setHeightofSideText(){
          ...
          if($('.subscription-style-header.head-1')) {
              var subscription_header_height_1 = 0;
              $('.subscription-style-header.head-1').css('height', '');
              if ($(window).width() >= 768) {
                  $('.subscription-style-header.head-1').each(function () {
                      if (subscription_header_height_1 < $(this).outerHeight()) {
                          subscription_header_height_1 = $(this).outerHeight();
                      }
                  });
                  $('.subscription-style-header.head-1').css('height', subscription_header_height_1 + 'px');
              }
          }

            if($('.subscription-style-header.head-2')) {
                var subscription_header_height_2 = 0;
                $('.subscription-style-header.head-2').css('height', '');
                if ($(window).width() >= 768) {
                    $('.subscription-style-header.head-2').each(function () {
                        if (subscription_header_height_2 < $(this).outerHeight()) {
                            subscription_header_height_2 = $(this).outerHeight();
                        }
                    });
                    $('.subscription-style-header.head-2').css('height', subscription_header_height_2 + 'px');
                }
            }

            if($('.subscription-style-header.head-3')) {
                var subscription_header_height_3 = 0;
                $('.subscription-style-header.head-3').css('height', '');
                if ($(window).width() >= 768) {
                    $('.subscription-style-header.head-3').each(function () {
                        if (subscription_header_height_3 < $(this).outerHeight()) {
                            subscription_header_height_3 = $(this).outerHeight();
                        }
                    });
                    $('.subscription-style-header.head-3').css('height', subscription_header_height_3 + 'px');
                }
            }

            if($('.subscription-style-body')) {
                var subscription_body_height = 0;
                $('.subscription-style-body').css('height', '');
                if ($(window).width() >= 768) {
                    $('.subscription-style-body').each(function () {
                        if (subscription_body_height < $(this).outerHeight()) {
                            subscription_body_height = $(this).outerHeight();
                        }
                    });
                    $('.subscription-style-body').css('height', subscription_body_height + 'px');
                }
            }
        }
