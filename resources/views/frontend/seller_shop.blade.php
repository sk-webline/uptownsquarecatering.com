...
@section('content')
    ...
    @if (!isset($type))
        <section class="mb-5">
            <div class="container">
                <div class="sk-carousel dots-inside-bottom mobile-img-auto-height" data-arrows="true" data-dots="true" data-autoplay="true">
        ...
        <section class="mb-4">
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        <div class="sk-carousel gutters-10" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-autoplay='true' data-infinute="true" data-dots="true">
                            @foreach ($shop->user->products->where('published', 1)->where('seller_featured', 1) as $key => $product)
                                <div class="carousel-box">
                                    <div class="sk-card-box border bg-white border-light rounded shadow-sm hov-shadow-md my-2 has-transition">
                                        <div class="position-relative">
                                            ...
                                            <div class="absolute-top-right sk-p-hov-icon">
    ...
    <section class="mb-4">
        <div class="container">
            ...
            <div class="sk-pagination sk-pagination-center mb-4">
                {{ $products->links() }}
            </div>
        </div>
    </section>
