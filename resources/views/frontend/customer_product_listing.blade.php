            ...
            <form class="" id="search-form" action="" method="GET">
                <div class="row">
                    <div class="col-xl-3 side-filter d-xl-block">
                        <div class="sk-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                            <div class="overlay overlay-fixed dark c-pointer" data-toggle="class-toggle" data-target=".sk-filter-sidebar" data-same=".filter-sidebar-thumb"></div>
                            <div class="collapse-sidebar c-scrollbar-light text-left">
                                <div class="d-flex d-xl-none justify-content-between align-items-center pl-3 border-bottom">
                                    <h3 class="h6 mb-0 fw-600">{{ translate('Filters') }}</h3>
                                    <button type="button" class="btn btn-sm p-2 filter-sidebar-thumb" data-toggle="class-toggle" data-target=".sk-filter-sidebar" type="button">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="text-left">
                            <div class="d-flex">
                                <div class="form-group w-200px">
                                    ...
                                    <select class="form-control form-control-sm sk-selectpicker" name="sort_by" onchange="filter()">
                                ...
                                <div class="form-group ml-auto mr-0 w-200px d-none d-md-block">
                                    ...
                                    <select class="form-control form-control-sm sk-selectpicker" name="condition" onchange="filter()">
                                ...
                                <div class="form-group ml-2 mr-0 w-200px d-none d-md-block">
                                    ...
                                    <select class="form-control form-control-sm sk-selectpicker" data-live-search="true" name="brand" onchange="filter()">
                                        <option value="">{{ translate('All Brands')}}</option>
                                        @foreach (\App\Brand::orderBy('order_level', 'desc')->get() as $brand)
                                ...
                                <div class="d-xl-none ml-auto ml-md-3 mr-0 form-group align-self-end">
                                    <button type="button" class="btn btn-icon p-0" data-toggle="class-toggle" data-target=".sk-filter-sidebar">
                        ...
                        <div class="row gutters-5 row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2">
                            @foreach ($customer_products as $key => $product)
                                <div class="col mb-2">
                                    <div class="sk-card-box border border-light rounded shadow-sm hov-shadow-md h-100 has-transition bg-white">
                        ...
                        <div class="sk-pagination sk-pagination-center mt-4">
