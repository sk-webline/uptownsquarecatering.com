          ...
          @csrf
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control sk-selectpicker" name="type" id="type" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="sk-text-editor" name="description">@php echo $manual_payment_method->description @endphp</textarea>
                    </div>
                </div>
                                ...
                                <div class="form-group row">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            @else
                                                <div class="col-sm-1">
                                                    <button type="button" class="btn btn-danger" onclick="removeBankInfoRow(this)">Remove</button>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
