        ...
        <div class="col-lg-5 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Edit Cashier')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" class="form-default"  action="{{ route('canteen_cashiers.update', $cashier->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-10px mb-sm-15px">
                            <div class="form-control-with-label small-focus small-field @if(old('name')) focused @endif ">
                                ...
                                <input type="text" class="form-control form-no-space{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{$name }}" name="name" required>
                            </div>
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group mb-10px mb-sm-15px">
                            <div class="form-control-with-label small-focus small-field @if(old('surname')) focused @endif ">
                                ...
                                <input type="text" class="form-control{{ $errors->has('surname') ? ' is-invalid' : '' }}" value="{{$surname }}" name="surname" required>
                            </div>
                        ...
                        <div class="form-group mb-10px mb-sm-15px">
                            <div class="form-control-with-label small-focus small-field ">
                                ...
                                <input type="text" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" value="{{ $cashier->username }}" name="username" required>
                            </div>
                            @if ($errors->has('username'))
                                <div class="invalid-feedback fs-10 d-block" role="alert">{{ $errors->first('username') }}</div>
                            @endif
                        </div>
                        ...
                        <div class="form-group mb-10px mb-sm-15px">
                            <div class="position-relative">
                                ...
                                <input type="number" lang="en" min="0"  class="form-control form-control-phone{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ $cashier->phone }}" name="phone">
                        ...
                        <div class="form-group mb-10px mb-sm-15px">
                            <div class="position-relative">
                                ...
                                <input type="text" lang="en"  class="form-control form-control-phone{{ $errors->has('city') ? ' is-invalid' : '' }}" value="{{ $cashier->city }}" name="city">
                            </div>
                            @if ($errors->has('city'))
                                <div class="invalid-feedback fs-10 d-block" role="alert">
                                    {{ $errors->first('city') }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <label class="sk-switch sk-switch-success mb-0">
                                    <input type="checkbox" name="active_cashier" @if($cashier->active==1) checked @endif >
                                    <span></span>
                                </label>
                            </div>
                        </div>
                                ...
                                @foreach($organisations as $organisation)
                                    ...
                                    <div class="col-md-6 mt-2">
                                        <label class="sk-switch sk-switch-success mb-0 ml-3">
                                            @if(in_array($organisation->id, $checked_organisations))
                                                <input class="lh-1-1" type="checkbox" value="{{$organisation->id}}" name="organisations[]" checked>
                                            @else
                        ...
                        <div class="form-group mb-0 text-right">
                            <a href="{{route('canteen_cashiers.index')}}">
