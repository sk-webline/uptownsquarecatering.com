      ...
      <div class="card-header row gutters-5">
        ...
        <div class="col-lg-2">
            <div class="form-group mb-0">
                <input type="text" class="sk-date-range form-control" value="{{ $date }}" name="date" placeholder="{{ translate('Filter by date') }}" data-format="DD-MM-Y" data-separator=" to " data-advanced-range="true" autocomplete="off">
            </div>
        </div>
          <div class="col-lg-2 ml-auto">
            <select class="form-control sk-selectpicker" name="payment_type" id="payment_type" onchange="sort_orders()">
          ...
          <div class="col-lg-2 ml-auto">
            <select class="form-control sk-selectpicker" name="delivery_status" id="delivery_status" onchange="sort_orders()">
