            ...
            <ul class="sk-side-nav-list" id="main-menu" data-toggle="sk-side-menu">
                    ...
                    @if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
                      <li class="sk-side-nav-item">
                        ...
                        <ul class="sk-side-nav-list level-2">
                            <li class="sk-side-nav-item">
                                <a href="{{route('poin-of-sales.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['poin-of-sales.index', 'poin-of-sales.create'])}}">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="sk-side-nav-item">
                        ...
                        <ul class="sk-side-nav-list level-2">
                            ...
                            <li class="sk-side-nav-item">
                                <a href="{{route('products.all')}}" class="sk-side-nav-link">
                                    <span class="sk-side-nav-text">{{ translate('All Products') }}</span>
                                </a>
                            </li>
                            <li class="sk-side-nav-item">
                                <a href="{{route('products.admin')}}" class="sk-side-nav-link {{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit']) }}" >
                                    <span class="sk-side-nav-text">{{ translate('In House Products') }}</span>
                                </a>
                            </li>
                            @if(\App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                <li class="sk-side-nav-item">
                                    <a href="{{route('products.seller')}}" class="sk-side-nav-link {{ areActiveRoutes(['products.seller', 'products.seller.edit']) }}">
                                        <span class="sk-side-nav-text">{{ translate('Seller Products') }}</span>
                                    </a>
                                </li>
                            @endif
                            <li class="sk-side-nav-item">
                                <a href="{{route('digitalproducts.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['digitalproducts.index', 'digitalproducts.create', 'digitalproducts.edit']) }}">
                            ...
                            <li class="sk-side-nav-item">
                                <a href="{{route('categories.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['categories.index', 'categories.create', 'categories.edit'])}}">
                                    <span class="sk-side-nav-text">{{translate('Category')}}</span>
                                </a>
                            </li>
                            <li class="sk-side-nav-item">
                                <a href="{{route('brands.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['brands.index', 'brands.create', 'brands.edit'])}}" >
                                    <span class="sk-side-nav-text">{{translate('Brand')}}</span>
                                </a>
                            </li>
                            <li class="sk-side-nav-item">
                                <a href="{{route('product_types.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['product_types.index', 'product_types.create', 'product_types.edit'])}}" >
                                    <span class="sk-side-nav-text">{{translate('Type')}}</span>
                                </a>
                            </li>
                            <li class="sk-side-nav-item">
                                <a href="{{route('attributes.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['attributes.index','attributes.create','attributes.edit'])}}">
                                    <span class="sk-side-nav-text">{{translate('Attribute')}}</span>
                                </a>
                            </li>
                            <li class="sk-side-nav-item">
                                <a href="{{route('colors')}}" class="sk-side-nav-link {{ areActiveRoutes(['colors','colors.edit'])}}">
                            ...
                            <li class="sk-side-nav-item">
                                <a href="javascript:void(0);" class="sk-side-nav-link {{ areActiveRoutes(['stores.index', 'stores.create', 'stores.edit','store_cities.index', 'store_cities.create', 'store_cities.edit'])}}">
                                    <span class="sk-side-nav-text">{{translate('Stores')}}</span>
                                    <span class="sk-side-nav-arrow"></span>
                                </a>
                                <ul class="sk-side-nav-list level-3">
                                    <li class="sk-side-nav-item">
                                        <a href="{{route('stores.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['stores.index', 'stores.create', 'stores.edit'])}}">
                                            <span class="sk-side-nav-text">{{translate('Stores')}}</span>
                                        </a>
                                    </li>
                ...
                <li class="sk-side-nav-item">
                    <a href="#" class="sk-side-nav-link">
                        ...
                        <span class="sk-side-nav-text">{{translate('Sales')}}</span>
                        <span class="sk-side-nav-arrow"></span>
                    </a>
                    <!--Submenu-->
                    <ul class="sk-side-nav-list level-2">
                        @if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="sk-side-nav-item">
                                <a href="{{ route('all_orders.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['all_orders.index', 'all_orders.show'])}}">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('4', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="sk-side-nav-item">
                                <a href="{{ route('inhouse_orders.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['inhouse_orders.index', 'inhouse_orders.show'])}}" >
                                    <span class="sk-side-nav-text">{{translate('Inhouse orders')}}</span>
                                </a>
                            </li>
                        @endif
                        @if(Auth::user()->user_type == 'admin' || in_array('5', json_decode(Auth::user()->staff->role->permissions)))
                          <li class="sk-side-nav-item">
                            <a href="{{ route('seller_orders.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['seller_orders.index', 'seller_orders.show'])}}">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('6', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="sk-side-nav-item">
                                <a href="{{ route('pick_up_point.order_index') }}" class="sk-side-nav-link {{ areActiveRoutes(['pick_up_point.order_index','pick_up_point.order_show'])}}">
                ...
                @if (\App\Addon::where('unique_identifier', 'refund_request')->first() != null && \App\Addon::where('unique_identifier', 'refund_request')->first()->activated)
                    @if(Auth::user()->user_type == 'admin' || in_array('7', json_decode(Auth::user()->staff->role->permissions)))
                      <li class="sk-side-nav-item">
                          ...
                          <ul class="sk-side-nav-list level-2">
                              <li class="sk-side-nav-item">
                                  <a href="{{route('refund_requests_all')}}" class="sk-side-nav-link {{ areActiveRoutes(['refund_requests_all', 'reason_show'])}}">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="sk-side-nav-item">
                        ...
                        <ul class="sk-side-nav-list level-2">
                            <li class="sk-side-nav-item">
                                <a href="{{ route('customers.index') }}" class="sk-side-nav-link">
                                    <span class="sk-side-nav-text">{{ translate('Customer list') }}</span>
                                </a>
                            </li>
                            <li class="sk-side-nav-item">
                                <a href="{{ route('partnership-user.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['partnership-user.index'])}}">
                            ...
                            <li class="sk-side-nav-item">
                                <a href="{{ route('customer_packages.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['customer_packages.index', 'customer_packages.create', 'customer_packages.edit'])}}">
                    ...
                    <li class="sk-side-nav-item">
                        ...
                        <ul class="sk-side-nav-list level-2">
                            <li class="sk-side-nav-item">
                                ...
                                @endphp
                                <a href="{{ route('sellers.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['sellers.index', 'sellers.create', 'sellers.edit', 'sellers.payment_history','sellers.approved','sellers.profile_modal','sellers.show_verification_request'])}}">
                            ...
                            <li class="sk-side-nav-item">
                                <a href="{{ route('business_settings.vendor_commission') }}" class="sk-side-nav-link">
                            ...
                            @if (\App\Addon::where('unique_identifier', 'seller_subscription')->first() != null && \App\Addon::where('unique_identifier', 'seller_subscription')->first()->activated)
                                <li class="sk-side-nav-item">
                                    <a href="{{ route('seller_packages.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['seller_packages.index', 'seller_packages.create', 'seller_packages.edit'])}}">
                            ...
                            <li class="sk-side-nav-item">
                                <a href="{{ route('seller_verification_form.index') }}" class="sk-side-nav-link">
                                    <span class="sk-side-nav-text">{{ translate('Seller Verification Form') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <li class="sk-side-nav-item">
                    <a href="{{ route('uploaded-files.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['uploaded-files.create'])}}">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="sk-side-nav-item">
                        ...
                        <ul class="sk-side-nav-list level-2">
                            <li class="sk-side-nav-item">
                                <a href="{{ route('in_house_sale_report.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['in_house_sale_report.index'])}}">
                                    <span class="sk-side-nav-text">{{ translate('In House Product Sale') }}</span>
                                </a>
                            </li>
                            <li class="sk-side-nav-item">
                                <a href="{{ route('seller_sale_report.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['seller_sale_report.index'])}}">
                                    <span class="sk-side-nav-text">{{ translate('Seller Products Sale') }}</span>
                                </a>
                            </li>
                            <li class="sk-side-nav-item">
                                <a href="{{ route('stock_report.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['stock_report.index'])}}">
                                    <span class="sk-side-nav-text">{{ translate('Products Stock') }}</span>
                                </a>
                            </li>
                            <li class="sk-side-nav-item">
                                <a href="{{ route('wish_report.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['wish_report.index'])}}">
                                    <span class="sk-side-nav-text">{{ translate('Products wishlist') }}</span>
                                </a>
                            </li>
                            <li class="sk-side-nav-item">
                                <a href="{{ route('user_search_report.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['user_search_report.index'])}}">
                ...
                <li class="sk-side-nav-item">
                    ...
                    <ul class="sk-side-nav-list level-2">
                        <li class="sk-side-nav-item">
                            <a href="{{ route('blog.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['blog.create', 'blog.edit'])}}">
                                <span class="sk-side-nav-text">{{ translate('All Posts') }}</span>
                            </a>
                        </li>
                        <li class="sk-side-nav-item">
                            <a href="{{ route('blog-category.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['blog-category.create', 'blog-category.edit'])}}">
                ...
                <!--Services-->
                <li class="sk-side-nav-item">
                    <a href="{{ route('services.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['services.index', 'services.create', 'services.edit'])}}">
                        <i class="las la-folder-open sk-side-nav-icon"></i>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('11', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="sk-side-nav-item">
                        ...
                        <ul class="sk-side-nav-list level-2">
                            @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                                <li class="sk-side-nav-item">
                                    <a href="{{ route('flash_deals.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['flash_deals.index', 'flash_deals.create', 'flash_deals.edit'])}}">
                            ...
                            <li class="sk-side-nav-item">
                                <a href="{{route('coupon.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['coupon.index','coupon.create','coupon.edit'])}}">
                  ...
                  <li class="sk-side-nav-item">
                      ...
                      <ul class="sk-side-nav-list level-2">
                          @if(Auth::user()->user_type == 'admin' || in_array('13', json_decode(Auth::user()->staff->role->permissions)))
                              ...
                              @endphp
                              <li class="sk-side-nav-item">
                                  <a href="{{ route('support_ticket.admin_index') }}" class="sk-side-nav-link {{ areActiveRoutes(['support_ticket.admin_index', 'support_ticket.admin_show'])}}">
                          ...
                          @if(Auth::user()->user_type == 'admin' || in_array('16', json_decode(Auth::user()->staff->role->permissions)))
                              <li class="sk-side-nav-item">
                                  <a href="{{ route('conversations.admin_index') }}" class="sk-side-nav-link {{ areActiveRoutes(['conversations.admin_index', 'conversations.admin_show'])}}">
                          ...
                          <ul class="sk-side-nav-list level-2">
                              <li class="sk-side-nav-item">
                                  <a href="{{route('affiliate.configs')}}" class="sk-side-nav-link">
                                      <span class="sk-side-nav-text">{{translate('Affiliate Registration Form')}}</span>
                                  </a>
                              </li>
                              <li class="sk-side-nav-item">
                              ...
                              <li class="sk-side-nav-item">
                                  <a href="{{route('affiliate.users')}}" class="sk-side-nav-link {{ areActiveRoutes(['affiliate.users', 'affiliate_users.show_verification_request', 'affiliate_user.payment_history'])}}">
                              ...
                              <li class="sk-side-nav-item">
                                  <a href="{{route('affiliate.withdraw_requests')}}" class="sk-side-nav-link">
                                      <span class="sk-side-nav-text">{{translate('Affiliate Withdraw Requests')}}</span>
                                  </a>
                              </li>
                              <li class="sk-side-nav-item">
                ...
                @if (\App\Addon::where('unique_identifier', 'offline_payment')->first() != null && \App\Addon::where('unique_identifier', 'offline_payment')->first()->activated)
                    @if(Auth::user()->user_type == 'admin' || in_array('16', json_decode(Auth::user()->staff->role->permissions)))
                      <li class="sk-side-nav-item">
                          ...
                          <ul class="sk-side-nav-list level-2">
                              <li class="sk-side-nav-item">
                                  <a href="{{ route('manual_payment_methods.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['manual_payment_methods.index', 'manual_payment_methods.create', 'manual_payment_methods.edit'])}}">
                                      <span class="sk-side-nav-text">{{translate('Manual Payment Methods')}}</span>
                                  </a>
                              </li>
                              <li class="sk-side-nav-item">
                                  <a href="{{ route('offline_wallet_recharge_request.index') }}" class="sk-side-nav-link">
                                      <span class="sk-side-nav-text">{{translate('Offline Wallet Recharge')}}</span>
                                  </a>
                              </li>
                              @if(\App\BusinessSetting::where('type', 'classified_product')->first()->value == 1)
                                  <li class="sk-side-nav-item">
                                      <a href="{{ route('offline_customer_package_payment_request.index') }}" class="sk-side-nav-link">
                                          <span class="sk-side-nav-text">{{translate('Offline Customer Package Payments')}}</span>
                                      </a>
                                  </li>
                              @endif
                              @if (\App\Addon::where('unique_identifier', 'seller_subscription')->first() != null && \App\Addon::where('unique_identifier', 'seller_subscription')->first()->activated)
                                  <li class="sk-side-nav-item">
                                      <a href="{{ route('offline_seller_package_payment_request.index') }}" class="sk-side-nav-link">
                                          <span class="sk-side-nav-text">{{translate('Offline Seller Package Payments')}}</span>
                                            @if (env("DEMO_MODE") == "On")
                                            <span class="badge badge-inline badge-danger">Addon</span>
                                            @endif
                                      </a>
                  ...
                  @if(Auth::user()->user_type == 'admin' || in_array('18', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="sk-side-nav-item">
                        ...
                        <ul class="sk-side-nav-list level-2">
                            ...
                            <li class="sk-side-nav-item">
                                <a href="{{route('set_product_points')}}" class="sk-side-nav-link {{ areActiveRoutes(['set_product_points', 'product_club_point.edit'])}}">
                                    <span class="sk-side-nav-text">{{translate('Set Product Point')}}</span>
                                </a>
                            </li>
                            <li class="sk-side-nav-item">
                                <a href="{{route('club_points.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['club_points.index', 'club_point.details'])}}">
                        ...
                        <ul class="sk-side-nav-list level-2">
                            ...
                            <li class="sk-side-nav-item">
                                <a href="{{route('african_credentials.index')}}" class="sk-side-nav-link">
                                    <span class="sk-side-nav-text">{{translate('Set African PG Credentials')}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('13', json_decode(Auth::user()->staff->role->permissions)))
                  <li class="sk-side-nav-item">
                    ...
                    <ul class="sk-side-nav-list level-2">
                        ...
                        <li class="sk-side-nav-item">
                            <a href="{{ route('website.pages') }}" class="sk-side-nav-link {{ areActiveRoutes(['website.pages', 'custom-pages.create' ,'custom-pages.edit'])}}">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('14', json_decode(Auth::user()->staff->role->permissions)))
                  <li class="sk-side-nav-item">
                    ...
                    <ul class="sk-side-nav-list level-2">
                        ...
                        <li class="sk-side-nav-item">
                            <a href="{{route('languages.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['languages.index', 'languages.create', 'languages.store', 'languages.show', 'languages.edit'])}}">
                        ...
                        <li class="sk-side-nav-item">
                            <a href="{{route('tax.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['tax.index', 'tax.create', 'tax.store', 'tax.show', 'tax.edit'])}}">
                                <span class="sk-side-nav-text">{{translate('Vat & TAX')}}</span>
                            </a>
                        </li>
                        <li class="sk-side-nav-item">
                            <a href="{{route('pick_up_points.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['pick_up_points.index','pick_up_points.create','pick_up_points.edit'])}}">
                        ...
                        <li class="sk-side-nav-item">
                            ...
                            <ul class="sk-side-nav-list level-3">
                                ...
                                <li class="sk-side-nav-item">
                                    <a href="{{route('countries.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['countries.index','countries.edit','countries.update'])}}">
                                        <span class="sk-side-nav-text">{{translate('Shipping Countries')}}</span>
                                    </a>
                                </li>
                                <li class="sk-side-nav-item">
                                    <a href="{{route('cities.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['cities.index','cities.edit','cities.update'])}}">
                                        <span class="sk-side-nav-text">{{translate('Shipping Cities')}}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('20', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="sk-side-nav-item">
                        ...
                        <ul class="sk-side-nav-list level-2">
                            <li class="sk-side-nav-item">
                                <a href="{{ route('staffs.index') }}" class="sk-side-nav-link {{ areActiveRoutes(['staffs.index', 'staffs.create', 'staffs.edit'])}}">
                                    <span class="sk-side-nav-text">{{translate('All staff')}}</span>
                                </a>
                            </li>
                            <li class="sk-side-nav-item">
                                <a href="{{route('roles.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['roles.index', 'roles.create', 'roles.edit'])}}">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('21', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="sk-side-nav-item">
                        <a href="{{route('addons.index')}}" class="sk-side-nav-link {{ areActiveRoutes(['addons.index', 'addons.create'])}}">
