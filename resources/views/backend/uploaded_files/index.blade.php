    ...
    <form id="sort_uploads" action="">
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-3 ml-auto mr-0">
                <select class="form-control form-control-xs sk-selectpicker" name="sort" onchange="sort_uploads()">
    		...
    		@foreach($all_uploads as $key => $file)
    			...
    			<div class="col-auto w-140px w-lg-220px">
    				<div class="sk-file-box">
    					...
    					<div class="card card-file sk-uploader-select c-default" title="{{ $file_name }}.{{ $file->extension }}">
...
@section('script')
	<script type="text/javascript">
		function detailsInfo(e){
			...
			$.post('{{ route('uploaded-files.info') }}', {_token: SK.data.csrf, id:id}, function(data){
