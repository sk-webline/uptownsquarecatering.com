...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">#{{ $conversation->title }} (Between @if($conversation->sender != null) {{ $conversation->sender->name }} @endif and 
                @if($conversation->receiver != null && $conversation->account_chat!=1) {{ $conversation->receiver->name }} @else {{translate('Admins')}} @endif
                )
            </h5>
        </div>
        ...
        <div class="card-body">
            ...
            @if (Auth::user()->id == $conversation->receiver_id || $conversation->account_chat==1)
