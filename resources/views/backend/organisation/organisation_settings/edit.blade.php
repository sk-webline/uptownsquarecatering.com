                ...
                <div class="card-body" id="settings-form">
                    <form class="form-horizontal"
                        ...
                        @if($organisation->catering==1)
                            ...
                            <div id='calendar' class="mt-2 mb-3 mx-auto " style="height: 500px!important;">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            old_start_date = '{{$organisation_setting->date_from}}';
            old_end_date = '{{$organisation_setting->date_to}}';
        ...
        //
        //     console.log('business:', businessDays);
        ...
        //         day= 0;
        //         flag=0
        //         day = moment(holidays[i]).isoWeekday();
        //
        //         if(day == '7'){
        //             day=0;
        //         }
        //
        //         console.log(holidays[i]+ " day: " + day);
        //
        //         // console.log(holidays[i] + " " + day);
        //
        //         for (var j = 0; j < businessDays.length; j++) {
        //             if (day == businessDays[j]) {
        //                 flag=1;
        //             }
        //         }
        //         console.log(holidays[i]+ " flag: " + flag);
        //
        //
        //         if (flag==0) {
        //
        //             console.log('no in->:', holidays[i]);
        //             if (calendar.getEventById(holidays[i]) != null) {
        //                 console.log('delete->:', calendar.getEventById(holidays[i]));
        //                 calendar.getEventById(holidays[i]).remove();
        //                 calendar.render();
        //             }
        //
        //             to_be_deleted.push(holidays[i]);
        //
        //         }
        //     }
        //
        //     for(var i=0 ; i<holidays.length; i++){
        //
        //         for(var j=0; j<to_be_deleted.length; j++){
        //
        //             if(holidays[i]==to_be_deleted[j])
        //                 holidays.splice(i, 1);
        //         }
        //
        //     }
        ...
        function createCalendarFromStart(){
            ...
            console.log('business_days start:', businessDays);

            for (var i = 0; i < old_holidays.length; i++) {
                holidays.push(old_holidays[i]);
            }

            console.log('holidays start: ',  holidays);
