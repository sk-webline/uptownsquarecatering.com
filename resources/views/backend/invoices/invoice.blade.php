    ...
    <div style="padding: 1rem;">
        <table class="padding text-left small border-bottom">
            ...
            <tr class="gry-color" style="background: #eceff4;">
                ...
                <th data-breakpoints="lg"
                    class="min-col text-center text-uppercase" width="80">{{translate('VAT')}} {{ $order->vat_percentage }}%
                </th>
                <th data-breakpoints="lg"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if($plan_purchase!=null && $plan_purchase->snack_quantity>0)
                                <br>
                                <span style="font-size: 0.8em ">{{ translate('Snacks per day') }}: {{ $plan_purchase->snack_quantity }}</span>
                            @endif
                            @if($plan_purchase!=null && $plan_purchase->meal_quantity>0)
                                <br>
                                <span style="font-size: 0.8em ">{{ translate('Lunches per day') }}: {{ $plan_purchase->meal_quantity }}</span>
                            @endif
                        </td>
                        <td>
