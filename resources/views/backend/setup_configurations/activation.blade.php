            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <label class="sk-switch sk-switch-success mb-0">
                        <input type="checkbox"
                               onchange="updateSettings(this, 'FORCE_HTTPS')" <?php if (env('FORCE_HTTPS') == 'On') echo "checked"; ?>>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <label class="sk-switch sk-switch-success mb-0">
                        <input type="checkbox"
                               onchange="updateSettings(this, 'disable_image_optimization')" <?php if (get_setting('disable_image_optimization') == 1) echo "checked"; ?>>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <label class="sk-switch sk-switch-success mb-0">
                        <input type="checkbox"
                               onchange="updateSettings(this, 'wallet_system')" <?php if (\App\BusinessSetting::where('type', 'wallet_system')->first()->value == 1) echo "checked"; ?>>
                        <span class="slider round"></span>
                    </label>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="clearfix">
                        ...
                        <label class="sk-switch sk-switch-success mb-0 float-right">
                            <input type="checkbox"
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="sk-switch sk-switch-success mb-0 float-right">
                            <input type="checkbox"
                                   onchange="updateSettings(this, 'sslcommerz_payment')" <?php if (\App\BusinessSetting::where('type', 'sslcommerz_payment')->first()->value == 1) echo "checked"; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="alert"
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="sk-switch sk-switch-success mb-0 float-right">
                            <input type="checkbox"
                                   onchange="updateSettings(this, 'instamojo_payment')" <?php if (\App\BusinessSetting::where('type', 'instamojo_payment')->first()->value == 1) echo "checked"; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="alert"
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="sk-switch sk-switch-success mb-0 float-right">
                            <input type="checkbox"
                                   onchange="updateSettings(this, 'razorpay')" <?php if (\App\BusinessSetting::where('type', 'razorpay')->first()->value == 1) echo "checked"; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="alert"
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="sk-switch sk-switch-success mb-0 float-right">
                            <input type="checkbox"
                                   onchange="updateSettings(this, 'paystack')" <?php if (\App\BusinessSetting::where('type', 'paystack')->first()->value == 1) echo "checked"; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="alert"
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="sk-switch sk-switch-success mb-0 float-right">
                            <input type="checkbox"
                                   onchange="updateSettings(this, 'voguepay')" <?php if (\App\BusinessSetting::where('type', 'voguepay')->first()->value == 1) echo "checked"; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="alert"
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="sk-switch sk-switch-success mb-0 float-right">
                            <input type="checkbox"
                                   onchange="updateSettings(this, 'payhere')" <?php if (\App\BusinessSetting::where('type', 'payhere')->first()->value == 1) echo "checked"; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="alert"
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="sk-switch sk-switch-success mb-0 float-right">
                            <input type="checkbox"
                                   onchange="updateSettings(this, 'ngenius')" <?php if (\App\BusinessSetting::where('type', 'ngenius')->first()->value == 1) echo "checked"; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="alert"
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="sk-switch sk-switch-success mb-0 float-right">
                            <input type="checkbox"
                                   onchange="updateSettings(this, 'iyzico')" <?php if (\App\BusinessSetting::where('type', 'iyzico')->first()->value == 1) echo "checked"; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="alert"
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="sk-switch sk-switch-success mb-0 float-right">
                            <input type="checkbox"
                                   onchange="updateSettings(this, 'bkash')" <?php if (\App\BusinessSetting::where('type', 'bkash')->first()->value == 1) echo "checked"; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="alert"
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="sk-switch sk-switch-success mb-0 float-right">
                            <input type="checkbox"
                                   onchange="updateSettings(this, 'nagad')" <?php if (\App\BusinessSetting::where('type', 'nagad')->first()->value == 1) echo "checked"; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                    <div class="alert"
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        ...
                        <label class="sk-switch sk-switch-success mb-0 float-right">
                            <input type="checkbox"
                                   onchange="updateSettings(this, 'cash_payment')" <?php if (\App\BusinessSetting::where('type', 'cash_payment')->first()->value == 1) echo "checked"; ?>>
                            <span class="slider round"></span>
                        </label>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <label class="sk-switch sk-switch-success mb-0">
                        <input type="checkbox"
                               onchange="updateSettings(this, 'twitter_login')" <?php if (\App\BusinessSetting::where('type', 'twitter_login')->first()->value == 1) echo "checked"; ?>>
                        <span class="slider round"></span>
                    </label>
                    <div class="alert"
                         style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
