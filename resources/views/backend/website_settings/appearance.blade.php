    		...
    		<div class="card">
    			...
    			<div class="card-body">
    				<form action="{{ route('business_settings.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Show Webshop')}}</label>
                            <div class="col-md-8">
                                <label class="sk-switch sk-switch-success mb-0">
                                    <input type="hidden" name="types[]" value="show_webshop">
                                    <input type="checkbox" name="show_webshop" @if( get_setting('show_webshop') == 'on') checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
    				...
    				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    					...
    					<div class="form-group row">
                            ...
                            <div class="col-md-8">
        						...
        						<textarea name="cookies_agreement_text" rows="4" class="sk-text-editor form-control" data-buttons='[["font", ["bold"]],["insert", ["link"]]]'>{{ get_setting('cookies_agreement_text') }}</textarea>
                            </div>
    					</div>
                        <div class="form-group row">
