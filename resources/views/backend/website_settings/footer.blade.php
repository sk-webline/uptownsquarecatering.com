    ...
    <div class="card">
    	...
    	<div class="card-body">
    		<div class="row gutters-10">
    					...
    					<div class="card-body">
    						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    			                ...
    			                <div class="form-group">
    								...
    								<textarea class="sk-text-editor form-control" name="about_us_description" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]' placeholder="Type.." data-min-height="150">
                ...
                @endif
    			<div class=" @if (hasAccessOnContent()) col-lg-6 @else col-12 @endif">
                    <div class="card shadow-none bg-light">
    					<div class="card-header">
    			                ...
    			                <div class="form-group">
    								...
    								<div class="w3-links-target">
    									...
    									@if (get_setting('widget_one_labels') != null)
    										@foreach (json_decode(App\BusinessSetting::where('type', 'widget_one_labels')->first()->value, true) as $key => $value)
                ...
                <div class="card shadow-none bg-light">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                  				...
                  				<textarea class="sk-text-editor form-control" name="frontend_copyright_text" data-buttons='[["font", ["bold", "underline", "italic"]],["insert", ["link"]],["view", ["undo","redo"]]]' placeholder="Type.." data-min-height="150">
